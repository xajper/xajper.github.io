document.addEventListener('DOMContentLoaded', function () {
    ...
    const commands = [
        ...
        { id: 134, category: '4fun', text: '🎠 Zagraj w wisielca', details: '<em>prefix</em> wisielec', tag: '4fun' , przyklad: '!wisielec'},

        // Komendy Ekonomii
        { id: 65, category: 'Ekonomia', text: '💵 Stan Konta', details: '<em>prefix</em> konto/bal/balance', tag: 'Ekonomia' , przyklad: '!konto'},
        { id: 66, category: 'Ekonomia', text: '⏰ Codzienny Zarobek', details: '<em>prefix</em> daily', tag: 'Ekonomia' , przyklad: '!daily'},
        { id: 67, category: 'Ekonomia', text: '✅ Kup Przedmiot', details: '<em>prefix</em> kup/buy {nazwa przedmiotu}', tag: 'Ekonomia' , przyklad: '!kup dom'},
        { id: 68, category: 'Ekonomia', text: '🤑 Sprzedaj Przedmiot', details: '<em>prefix</em> sprzedaj/sell {nazwa przedmioty}', tag: 'Ekonomia' , przyklad: '!sprzedaj krzesło'},
        { id: 69, category: 'Ekonomia', text: '💳 Wypłać Pieniądze', details: '<em>prefix</em> with {all/ilość}', tag: 'Ekonomia' , przyklad: '!with all'},
        { id: 70, category: 'Ekonomia', text: '🏦 Wpłać Pieniądze', details: '<em>prefix</em> dep {all/ilość}', tag: 'Ekonomia' , przyklad: '!dep 100'},
        { id: 71, category: 'Ekonomia', text: '⬆ Topka Najbogatszych Ludzi', details: '<em>prefix</em> lb/leaderboard/topmoney', tag: 'Ekonomia' , przyklad: '!lb'},
        { id: 72, category: 'Ekonomia', text: '🤑 Hazard', details: '<em>prefix</em> hazard {ilość pieniędzy do postawienia}', tag: 'Ekonomia' , przyklad: '!hazard 50'},
        { id: 73, category: 'Ekonomia', text: '🎰 Kasyno', details: '<em>prefix</em> kasyno {ilość pieniędzy do postawienia}', tag: 'Ekonomia' , przyklad: '!kasyno 20'},
        { id: 74, category: 'Ekonomia', text: '🎣 Łowienie Ryb', details: '<em>prefix</em> jezioro', tag: 'Ekonomia' , przyklad: '!jezioro'},
        { id: 75, category: 'Ekonomia', text: '⛺ Polowanie', details: '<em>prefix</em> polowanie', tag: 'Ekonomia' , przyklad: '!polowanie'},
        { id: 76, category: 'Ekonomia', text: '⛏️ Kopalnia', details: '<em>prefix</em> kopalnia', tag: 'Ekonomia' , przyklad: '!kopalnia'},
        { id: 77, category: 'Ekonomia', text: '🪓 Tartak', details: '<em>prefix</em> tartak', tag: 'Ekonomia' , przyklad: '!tartak'},
        { id: 78, category: 'Ekonomia', text: '🛒 Sklep', details: '<em>prefix</em> sklep', tag: 'Ekonomia' , przyklad: '!sklep'},
        { id: 79, category: 'Ekonomia', text: '📦 Lista Skrzynek', details: '<em>prefix</em> skrzynki', tag: 'Ekonomia' , przyklad: '!skrzynki'},
        { id: 80, category: 'Ekonomia', text: '🔓 Otwórz Skrzynkę', details: '<em>prefix</em> otwórz {rodzaj skrzynki}', tag: 'Ekonomia' , przyklad: '!otwórz epicka'},
        { id: 81, category: 'Ekonomia', text: '🦹‍♂️ Kradzież', details: '<em>prefix</em> rob {@użytkownik}', tag: 'Ekonomia' , przyklad: '!rob @Xajper'},
        { id: 82, category: 'Ekonomia', text: '🏰 Twój Ekwipunek', details: '<em>prefix</em> eq/inv/inventory', tag: 'Ekonomia' , przyklad: '!inv'},
        { id: 83, category: 'Ekonomia', text: '[WKRÓTCE] 🎓 Edukacja to podstawa! Chcesz zarabiać więcej? Poucz się!', details: '<em>prefix</em> edukacja/nauka {ilość pieniędzy przeznaczona na edukację}', tag: 'Ekonomia' , przyklad: '!nauka 500'},
        { id: 84, category: 'Ekonomia', text: '🪙 Rzut monetą', details: '<em>prefix</em> cf {kwota} {orzeł/reszka}', tag: 'Ekonomia' , przyklad: '!cf 10 orzeł'},
        { id: 85, category: 'Ekonomia', text: '🚨 Crime', details: '<em>prefix</em> crime', tag: 'Ekonomia' , przyklad: '!crime'},
        { id: 86, category: 'Ekonomia', text: '💼 Nagrody z ról', details: '<em>prefix</em> collect', tag: 'Ekonomia' , przyklad: '!collect'},
        { id: 87, category: 'Ekonomia', text: '🧑‍🏫 Rozwiązywanie działań matematycznych', details: '<em>prefix</em> math', tag: 'Ekonomia' , przyklad: '!math'},
        { id: 88, category: 'Ekonomia', text: '🥏 Ruletka', details: '<em>prefix</em> ruletka {kwota} {liczba|kolor|liczba parzysta/nieparzysta}', tag: 'Ekonomia' , przyklad: '!ruletka 50 czerwony'},

        // Komendy Systemu Poziomów
        { id: 89, category: 'Poziomy', text: '[WKRÓTCE] 💠 Twój Aktualnym Poziom', details: '<em>prefix</em> rank', tag: 'Poziomy' , przyklad: '!rank'},
        { id: 90, category: 'Poziomy', text: '[WKRÓTCE] 📈 Topka Ludzi z Najwyższym Poziomem:', details: '<em>prefix</em> toplvl', tag: 'Poziomy' , przyklad: '!toplvl'},

        // Komendy do Muzyki
        { id: 91, category: 'Muzyka', text: '🎵 Start', details: '<em>prefix</em> play {nazwa/link}', tag: 'Muzyka' , przyklad: '!play nazwa muzyki'},
        { id: 92, category: 'Muzyka', text: '🔒 Stop', details: '<em>prefix</em> stop', tag: 'Muzyka' , przyklad: '!stop'},
        { id: 93, category: 'Muzyka', text: '🪃 Zatrzymaj', details: '<em>prefix</em> pause/zatrzymaj', tag: 'Muzyka' , przyklad: '!pause'},
        { id: 94, category: 'Muzyka', text: '🎧 Wznów muzykę', details: '<em>prefix</em> resume/wznów', tag: 'Muzyka' , przyklad: '!wznów'},
        { id: 95, category: 'Muzyka', text: '🎞️ Playlista/Kolejka', details: '<em>prefix</em> playlista/kolejka', tag: 'Muzyka' , przyklad: '!playlista'},
        { id: 96, category: 'Muzyka', text: '🧹 Wyczyść playlistę', details: '<em>prefix</em> kolejka_clear/playlista_clear', tag: 'Muzyka' , przyklad: '!kolejka_clear'},
        { id: 97, category: 'Muzyka', text: '🚫 Usuń muzykę z playlisty', details: '<em>prefix</em> remove', tag: 'Muzyka' , przyklad: '!remove'},
        { id: 98, category: 'Muzyka', text: '➡️ Pomiń muzykę', details: '<em>prefix</em> skip', tag: 'Muzyka' , przyklad: '!skip'},

        // Komendy do gry RPG
        { id: 99, category: 'RPG', text: '⚔️ Pojedynek', details: '<em>prefix</em> walka {@przeciwnik}', tag: 'RPG' , przyklad: '!walka @Xajper'},
        { id: 100, category: 'RPG', text: '💪 Trening', details: '<em>prefix</em> trening', tag: 'RPG' , przyklad: '!trening'},
        { id: 101, category: 'RPG', text: '⬆️ Ulepszanie statystyk', details: '<em>prefix</em> ulepsz', tag: 'RPG' , przyklad: '!ulepsz'},
        { id: 102, category: 'RPG', text: '🛒 Rynek', details: '<em>prefix</em> rynek', tag: 'RPG' , przyklad: '!rynek'},
        { id: 103, category: 'RPG', text: '🛡️ Kupowanie zbroi/broni', details: '<em>prefix</em> wyposaż {nazwa przedmiotu}', tag: 'RPG' , przyklad: '!wyposaż miecz'},
        { id: 104, category: 'RPG', text: '💥 Wyzwania', details: '<em>prefix</em> wyzwania/wyzwanie/quest/zadania/questy', tag: 'RPG' , przyklad: '!questy'},
        { id: 105, category: 'RPG', text: '🏟️ Walka z potworami', details: '<em>prefix</em> arena', tag: 'RPG' , przyklad: '!arena'},
        ...
        { id: 109, category: 'RPG', text: '💱 Wymiany', details: '<em>prefix</em> trade/wymiana {@użytkownik} {przedmiot który oddajesz} {przedmiot który przyjmujesz}', tag: 'RPG' , przyklad: '!trade @Xajper łuk miecz'},
        ...
        { id: 113, category: 'RPG', text: '💚 Medyk', details: '<em>prefix</em> medyk', tag: 'RPG' , przyklad: '!medyk'},
        { id: 114, category: 'RPG', text: '🎒 Plecak', details: '<em>prefix</em> plecak', tag: 'RPG' , przyklad: '!plecak'},
        { id: 115, category: 'RPG', text: '🔬 Odkrywaj nowe miejsca i tym samym nowe przedmioty', details: '<em>prefix</em> explore/travel/podróż/odkryj', tag: 'RPG' , przyklad: '!explore'},
        { id: 116, category: 'RPG', text: '📜 Lista twoich osiągnięć', details: '<em>prefix</em> osiągnięcia/achievements', tag: 'RPG' , przyklad: '!osiągnięcia'},
        { id: 117, category: 'RPG', text: '🆚 Walka z npc', details: '<em>prefix</em> npc', tag: 'RPG' , przyklad: '!npc'},
        { id: 118, category: 'RPG', text: '📊 Najlepsi gracze', details: '<em>prefix</em> ranking', tag: 'RPG' , przyklad: '!ranking'},
        { id: 119, category: 'RPG', text: '🔥 Lista dostępnych klas', details: '<em>prefix</em> klasy', tag: 'RPG' , przyklad: '!klasy'},
        { id: 120, category: 'RPG', text: '🤣 Śmieszne teskty Jaskra', details: '<em>prefix</em> Jaskier/jaskier', tag: 'RPG' , przyklad: '!jaskier'},
        { id: 121, category: 'RPG', text: '⚱️ Poznaj historię świata pod komendą', details: '<em>prefix</em> historia', tag: 'RPG' , przyklad: '!historia'},

        // Komendy do Gry Menadżer
        { id: 122, category: 'Menadżer [ANULOWANE]', text: '📜 Lista sponsorów', details: '<em>prefix</em> sponsor', tag: 'Menadżer [ANULOWANE]' , przyklad: '!sponsor'},
        { id: 123, category: 'Menadżer [ANULOWANE]', text: '🧠 Taktyka', details: '<em>prefix</em> taktyka', tag: 'Menadżer [ANULOWANE]' , przyklad: '!taktyka'},
        { id: 124, category: 'Menadżer [ANULOWANE]', text: '📊 Tabela ligowa', details: '<em>prefix</em> tabela', tag: 'Menadżer [ANULOWANE]' , przyklad: '!tabela'},
        { id: 125, category: 'Menadżer [ANULOWANE]', text: '📈 Statystyki klubu', details: '<em>prefix</em> statystyki', tag: 'Menadżer [ANULOWANE]' , przyklad: '!statystyki'},
        { id: 126, category: 'Menadżer [ANULOWANE]', text: '🏅 Nagrody za wygranie czegoś', details: '<em>prefix</em> nagrody', tag: 'Menadżer [ANULOWANE]' , przyklad: '!nagrody'},
        { id: 127, category: 'Menadżer [ANULOWANE]', text: '🧔‍♂️ Lista trenerów', details: '<em>prefix</em> trener', tag: 'Menadżer [ANULOWANE]' , przyklad: '!trener'},
        { id: 128, category: 'Menadżer [ANULOWANE]', text: '💻 Lista piłkarzy', details: '<em>prefix</em> piłkarze {klub}', tag: 'Menadżer [ANULOWANE]' , przyklad: '!piłkarze FC Barcelona'},
        { id: 129, category: 'Menadżer [ANULOWANE]', text: '📑 Lista klubów', details: '<em>prefix</em> kluby', tag: 'Menadżer [ANULOWANE]' , przyklad: '!kluby'},
        { id: 130, category: 'Menadżer [ANULOWANE]', text: '📆 Terminarz', details: '<em>prefix</em> terminarz', tag: 'Menadżer [ANULOWANE]' , przyklad: '!terminarz'},
